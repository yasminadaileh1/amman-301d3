...
//  it will refered to the object itself the constructor 
// 2. What is "this" when joe.scopeArrow() is invoked?
// reffered to the window 
// 3. Explain why "this" is different when an arrow function is used.
//arrow function doesn't have this so when you use this in arrow function it will go to this for the enclosing scope 
