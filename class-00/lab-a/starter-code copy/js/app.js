...
function displayPics(){
  ...
  // the error was in the rando variable because when we use let to deacler a varaible we can't reassign a new value in the same scope so I delete the variable that calling the function and call the function direct.
  console.log(viewed);
